    ...
    <LinearGradient
      ...
      <ScrollView
        ...
        <Animatable.View animation="fadeInUp" delay={600}>
          <GlassCard style={styles.comingSoonCard} glow="accent">
            <View style={styles.comingSoonContent}>
              <Icon name="construction" size={48} color={theme.colors.accent} />
              ...
              <Text style={[styles.comingSoonDescription, {color: theme.colors.textSecondary}]}>
                This feature will include calendar navigation, daily tracking cards,
        ...
        <Animatable.View animation="fadeInUp" delay={900}>
          ...
          {[
            {icon: 'calendar-week', title: 'Horizontal Calendar', desc: 'Swipe through dates'},
            {icon: 'water', title: 'Water Tracking', desc: 'Visual progress indicators'},
            {icon: 'sleep', title: 'Sleep Logging', desc: 'Quality and duration tracking'},
            {icon: 'food', title: 'Meal Planning', desc: 'Comprehensive food diary'},
            {icon: 'dumbbell', title: 'Workout Log', desc: 'Exercise and progress tracking'},
          ].map((feature, index) => (
            <Animatable.View
              key={index}
